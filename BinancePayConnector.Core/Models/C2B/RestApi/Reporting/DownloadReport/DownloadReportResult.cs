using BinancePayConnector.Core.Models.C2B.RestApi.Reporting.DownloadReport.Enums;

namespace BinancePayConnector.Core.Models.C2B.RestApi.Reporting.DownloadReport;
