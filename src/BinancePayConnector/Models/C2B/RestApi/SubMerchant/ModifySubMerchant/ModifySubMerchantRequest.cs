...
using BinancePayConnector.Models.C2B.RestApi.SubMerchant.Common.Enums;

namespace BinancePayConnector.Models.C2B.RestApi.SubMerchant.ModifySubMerchant;

/// <summary>
/// You can see this in official documentation: <see href="https://developers.binance.com/docs/binance-pay/api-submerchant-modify#request-parameters"/>.
/// </summary>
/// <param name="SubMerchantId">Sub-merchant ID returned by create sub-merchant api should be all number.</param>
...
/// <param name="CertificateType">You can convert int value to enum <see cref="CreateSubMerchant.Enums.CertificateType"/>.</param>
...
public sealed record ModifySubMerchantRequest(
