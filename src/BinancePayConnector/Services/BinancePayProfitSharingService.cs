        ...
        : IBinancePayProfitSharingService
{
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<AddReceiverResult>();
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<QueryReceiverResult>();
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<DeleteReceiverResult>();
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<SubmitSplitResult>();
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<QuerySplitResult>();
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            return e.AsBinancePayResult<SplitReturnResult>();
        }
    }
}
